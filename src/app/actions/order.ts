...
export async function submitOrder(prevState: any, formData: FormData) {
  try {
    ...
    if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.SUPABASE_SERVICE_ROLE_KEY) {
      ...
      let finalPrice = 0
      if (packageSelected.includes('باك 1') || packageSelected.includes('1')) finalPrice = 220
      ...
      if (finalPrice === 0) finalPrice = 220 // Fallback
      ...
      // Trigger Integrations & Email Alerts
