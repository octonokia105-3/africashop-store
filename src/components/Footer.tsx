    ...
    <footer className="bg-void border-t border-border pt-20 pb-10">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-gold to-[#f0c84a] flex items-center justify-center font-black text-void text-xl shadow-md">
                A
              </div>
            ...
            <p className="text-muted text-sm leading-relaxed">
              المتجر الرائد في تقديم أقوى الباقات والعروض الاستثنائية لعملائنا في جميع أنحاء المغرب وإفريقيا. جودة مضمونة وتوصيل سريع.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-muted">
              ...
              <li className="flex items-center gap-3"><Mail className="w-4 h-4 text-gold" /> support@africashop.ma</li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-8 text-center text-xs text-muted flex flex-col md:flex-row justify-between items-center gap-4">
          <p>© 2026 AfricaShop. جميع الحقوق محفوظة.</p>
