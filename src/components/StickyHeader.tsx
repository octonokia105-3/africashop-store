    ...
    <header className="sticky top-0 z-[100] bg-void/90 backdrop-blur-xl border-b border-border py-3 transition-colors duration-300">
      <div className="container mx-auto max-w-7xl px-6 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-gold to-[#f0c84a] flex items-center justify-center font-black text-void text-lg shadow-md">
            A
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <a 
            href="#checkout"
            className="bg-gold text-white font-bold text-sm px-5 py-2 rounded-full hover:bg-gold-hover hover:shadow-[0_0_20px_rgba(232,93,136,0.35)] hover:-translate-y-[1px] transition-all whitespace-nowrap flex items-center gap-2"
          >
